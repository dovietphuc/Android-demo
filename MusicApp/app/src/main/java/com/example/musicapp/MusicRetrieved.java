...
public class MusicRetrieved extends AsyncTaskLoader<List<Song>> {
    ...
    public MusicRetrieved(@NonNull Context context, OnFinishRetrieved finishRetrieved) {
        super(context);
        mOnFinishRetrieved = finishRetrieved;
    }
    ...
    public List<Song> loadInBackground() {
        ...
        if(cursor != null ) {
            while (cursor.moveToNext()) {
                ...
                int albumIdIndex = cursor.getColumnIndexOrThrow(MediaStore.Audio.Albums.ALBUM_ID);
